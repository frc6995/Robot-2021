...
public class DrivebaseArcadeDriveStickControllerC extends CommandBase {
   ...
   */
  public DrivebaseArcadeDriveStickControllerC(DifferentialDrivebaseS drivebase, DriveConstants driveConstants,
      GenericHID controller) {
  ...
  public void execute() {
    ...
    drivebaseS.drivePercentages(drivebaseS.arcadeDriveController(driveSpeed * 0.4, turnSpeed * -0.25).clamp());
  }
