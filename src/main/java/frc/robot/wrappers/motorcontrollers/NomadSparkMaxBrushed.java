 ...
 */
public class NomadSparkMaxBrushed extends CANSparkMax implements NomadBaseMotor {
     ...
     */
    public NomadSparkMaxBrushed(int port, boolean inverted, NomadBaseMotor leader) {
        this(port, inverted);
        setLeader(leader);
    }
    ...
    public NomadBaseMotor setLeader( NomadBaseMotor leader){
        ...
        if (leader instanceof NomadSparkMaxBrushed) {
            follow((NomadSparkMaxBrushed) leader);
        } else {
